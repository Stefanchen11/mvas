...
var array_day = new Array("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday");
 ...
 // general
var win = '₦900,000 cash'; // Prize
var win_brand = ''; // Prize
var win_box = 'ixs_box.png'; // Prize in box
var title = 'Find ₦900,000'; // Title
...
var b = "MTN Special commemorative Events, only today: <span class='date_day_number'></span>. <span class='date_month'></span>"; // subtitle
var d = "Dear user,"; // 
var e = "Every <span class = 'date_day_week'> </span> we select 6 lucky users who get the chance to win ₦900,000 cash </span>."; //
...
var m_1_t = 'MTN Lucky Draw'; // Modal 1 title
var m_1_d = [{ // Modal 1 description
	"1": "Congratulations, Android user!",
	"2": "As a sponsored promotion, you can win <strong> ₦900,000</strong>.",
...
var m_3_s = '(1) <strong>₦900,000</strong> has been reserved '; // Modal 3 title
var m_3_d = [{ // Modal 3 description
	"1": "1. Click the button below.",
	"2": "2. Enter your phone number on the next page.",
	"3": "3. Your <strong>₦900,000</strong> will be recharged to your personal account"
}];
